              ...
              <div className="mt-10 flex flex-col gap-8">
                <div className="">
                  ...
                  <p className="m-0 text-[#24181B80]">
                    Join us for a day of furry fun and community service at Paws
                    for a Cause! Grab your leashes and bring your love for dogs
                    to Maplewood High School&apos;s volunteering event.
                    We&apos;re teaming up to provide some much-needed exercise
                    and socialization for our furry friends at the local animal
                    shelter.
                  </p>
                </div>
          ...
          <div className="w-full bg-white rounded-3xl relative overflow-hidden mt-10 p-5 ">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex gap-1 text-base text-[#24181B]">
                ...
                123 Bark Avenue, Miami, FL 33101
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <button className="text-base  w-full h-[58px] px-4 py-3 flex justify-center items-center bg-[#E60054] rounded-xl font-medium text-white hover:bg-[#C20038]">
                Join the event
              </button>
            </div>
            ...
            <div className="flex flex-col gap-5 hidden">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-base text-[#24181B] mb-2">
                  ...
                  arrive 15 minutes before the start time. Your punctuality will
                  greatly assist with our organization efforts.
                </p>
                <p className="text-base text-[#24181B] mb-2">
