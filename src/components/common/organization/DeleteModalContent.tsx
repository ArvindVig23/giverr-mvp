    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-end p-6 pt-5  rounded-b gap-2.5">
        ...
        <button
          ...
          className={`text-base w-full h-11 py-3 flex justify-center items-center bg-[#E60054] rounded-xl font-medium text-white hover:bg-[#C20038] ${usernameValue !== userOrgDetails.username ? 'cursor-not-allowed' : ''}`}
          type="button"
