  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 flex-1">
        <div className="relative w-full materialDatepicker">
          <Controller
            name="dateRange"
            control={control}
        ...
        <div className="relative w-full mt-1">
          ...
          <select
            ...
            className="block rounded-xl px-5 pb-2.5 pt-6 w-full text-base text-[#24181B] bg-[#EDEBE3]  border border-[#E6E3D6] appearance-none focus:outline-none focus:ring-0 focus:border-[#E60054] peer"
          >
